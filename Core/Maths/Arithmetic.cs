...
namespace Trivial.Maths
{
    ...
    public static class ArithmeticUtility
    {
        ...
        public static long Factorial(uint value)
        {
            ...
            for (var step = 2; step < value; step++)
            {
                resultNum *= step;
            }
        ...
        {
            if (leftValue == null) throw new ArgumentNullException("leftValue");
            if (rightValue == null) throw new ArgumentNullException("rightValue");
