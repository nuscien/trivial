...
namespace Trivial.Text
{
    ...
    public class JsonArray : IJsonComplex, IJsonValueResolver, IReadOnlyList<IJsonValue>, IReadOnlyList<IJsonValueResolver>, IEquatable<JsonArray>, IEquatable<IJsonValue>
    {
        ...
        /// <summary>
        /// Determines the item value of the index is null.
        /// </summary>
        /// <param name="index">The zero-based index of the element to get.</param>
        ...
        /// <summary>
        /// Determinesthe item value of the index is null, undefined or nonexisted.
        /// </summary>
        /// <param name="index">The zero-based index of the element to get.</param>
        /// <returns>true if the item value is null; otherwise, false.</returns>
        ...
        /// <summary>
        /// Determines whether it contains an item value with the index.
        /// </summary>
        /// <param name="index">The zero-based index of the element to get.</param>
        ...
        public static Task<JsonArray> ParseAsync(System.IO.Compression.ZipArchive zip, string entryName, JsonDocumentOptions options, CancellationToken cancellationToken = default)
        {
            var entry = zip?.GetEntry(entryName);
            if (entry == null) return Task.FromResult<JsonArray>(null);
        ...
        /// <exception cref="NotSupportedException">The zip archive does not support reading.</exception>
        /// <exception cref="InvalidDataException">The zip archive is corrupt, and the entry cannot be retrieved.</exception>
        public static Task<JsonArray> ParseAsync(System.IO.Compression.ZipArchive zip, string entryName, CancellationToken cancellationToken = default)
