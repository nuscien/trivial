...
namespace Trivial.Text
{
    ...
    public class JsonBooleanNode : IJsonValueNode<bool>, IJsonDataNode
    {
        ...
        IEnumerable<string> IJsonDataNode.GetKeys() => throw new InvalidOperationException("Expect an object but it is a boolean value.");
        ...
        {
            return new JsonIntegerNode(leftValue?.Value == true ? 1 : 0);
        }
