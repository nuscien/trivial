...
namespace Trivial.Geography
{
    ...
    public class GeolocationUnitTest
    {
        ...
        {
            var latitude = new Latitude.Model(56.7 + 90);
            Assert.AreEqual(90 - 56.7, latitude.Degrees, delta);
            ...
            latitude = new Latitude.Model(-56.7 - 90);
            Assert.AreEqual(56.7 - 90, latitude.Degrees, delta);
            Assert.AreEqual(Latitudes.South, latitude.Type);
            latitude.Degree = 180;
            Assert.AreEqual(0.7, latitude.Degrees, delta);
            Assert.AreEqual(Latitudes.South, latitude.Type);
