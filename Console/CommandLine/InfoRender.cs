...
namespace Trivial.CommandLine
{
    ...
    public static partial class ConsoleRenderExtensions
    {
        ...
        public static void Write(this StyleConsole cli, LinearGradientConsoleStyle style, string s, params object[] args)
        {
            if (cli == null) cli = StyleConsole.Default;
            if (style == null)
            {
            ...
            var col = style.CreateTextCollection(args == null || args.Length == 0 ? s : string.Format(s, args));
            cli.Write(col);
        }
        ...
        public static void Write(this StyleConsole cli, LinearGradientConsoleStyle style, char value, int repeatCount = 1)
        {
            if (cli == null) cli = StyleConsole.Default;
            if (style == null || repeatCount < 1)
            {
                cli.Write(value, repeatCount);
                return;
            }

            var col = style.CreateTextCollection(new string(value, repeatCount));
            cli.Write(col);
        }
        ...
        /// <param name="s">A composite format string to output.</param>
        /// <param name="args">An object array that contains zero or more objects to format.</param>
        public static void WriteLine(this StyleConsole cli, LinearGradientConsoleStyle style, string s, params object[] args)
        {
            if (cli == null) cli = StyleConsole.Default;
            if (style == null)
            {
                cli.WriteLine(s, args);
                return;
            }
        ...
        /// <param name="value">The value to write.</param>
        /// <param name="repeatCount">The number of times to append value.</param>
        public static void WriteLine(this StyleConsole cli, LinearGradientConsoleStyle style, char value, int repeatCount = 1)
        {
            if (cli == null) cli = StyleConsole.Default;
            if (style == null || repeatCount < 1)
            {
                cli.WriteLine(value, repeatCount);
                return;
            }
