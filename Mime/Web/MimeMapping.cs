...
namespace Trivial.Web
{
    ...
    {
        internal static class WebFormat
        {
            /// <summary>
            /// The MIME mapping.
            /// </summary>
            internal static KeyedDataMapping<string> MimeMapping { get; } = new();
            ...
            internal static string GetMime(string fileExtension)
            {
                ...
                return fileExtension.Remove(0, 1) switch
                {
                    ...
                    // Text
                    "txt" or "text" or "log" or "def" or "ini" or "gitignore" or "editorconfig" => "text/plain",
                    "csv" => "text/csv",
                    "tsv" => "text/tsv",
                    "md" => "text/markdown",
                    "mml" => "text/mathml",
                    ...
                    "htm" or "html" or "shtml" or "hta" => "text/html",
                    "ink" or "inkml" => "application/inkml+xml",
                    "js" or "jsx" or "esm" => "text/javascript",
                    ...
                    "xml" or "xsl" or "config" => "application/xml",
                    "vbs" => "text/vbscript",
                    ...
                    "qs" => "text/x-qsharp",
                    "vb" => "text/x-vb",
                    "csproj" or "csdproj" or "vbproj" or "vbdproj" => "text/plain",
