...
namespace Trivial.Web
{
    ...
    {
        /// <summary>
        /// The popular MIME constants of web content.
        /// </summary>
        public static class Web
        {
            /// <summary>
            /// The MIME content type of Cascading Style Sheets.
            /// </summary>
            public const string Css = "text/css";

            /// <summary>
            /// The MIME content type of Syntactically Awesome Style Sheets.
            /// </summary>
            public const string Sass = "text/x-sass";

            /// <summary>
            /// The MIME content type of Sassy Cascaded Style Sheets.
            /// </summary>
            public const string Scss = "text/x-scss";

            /// <summary>
            /// The MIME content type of Leaner CSS.
            /// </summary>
            public const string Less = "text/x-less";

            /// <summary>
            /// The MIME content type of Document Type Definition.
            /// </summary>
            public const string Dtd = "application/xml-dtd";

            /// <summary>
            /// The MIME content type of ECMA Script.
            /// </summary>
            ...
            /// <summary>
            /// The MIME content type of HTML (Hypertext Markup Language).
            /// </summary>
            public const string Html = "text/html";

            /// <summary>
            /// The MIME content type of JSON (JavaScript Object Notation).
            /// </summary>
            ...
            /// <summary>
            /// The MIME content type of Extensible Markup Language.
            /// </summary>
            public const string Xml = "application/xml";

            /// <summary>
            /// The MIME content type of Uniform Resource Identifier list.
            /// </summary>
